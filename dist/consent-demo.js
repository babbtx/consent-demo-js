(function () {
	...
	var consentServer = "https://localhost:18443";
	var consentAccount = "Consent Demo";
	var consentPassword = "CHANGE-ME";
	var env$1 = {
		consentServer: consentServer,
		consentAccount: consentAccount,
		consentPassword: consentPassword
	};
	...
	var ConsentPrompt = function () {
	  ...
	  createClass$1(ConsentPrompt, [{
	        ...
	        return regeneratorRuntime.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	                url = env$1.consentServer + "/consent/v1/definitions/" + this.definition + "/localizations/en-US";
	                _context.next = 3;
	                return axios$1.get(url, { auth: { username: env$1.consentAccount, password: env$1.consentPassword } });
	    ...
	    key: "showPromptWithPromise",
	    value: function showPromptWithPromise() {
	      return new Promise(function (resolve, reject) {
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 2:
	                ...
	                _context2.next = 5;
	                return this.showPromptWithPromise();
	    ...
	    value: function init() {
	      ...
	      if ($("#consent-prompt-modal").length === 0) {
	        $("body").append(html);
	        $("#consent-prompt-modal .consent-prompt-modal__button[data-response=accepted]").on("click", function () {
	...
	var getConsentStatus = function () {
	  var _ref = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
	    ...
	    return regeneratorRuntime.wrap(function _callee$(_context) {
	      while (1) {
	        switch (_context.prev = _context.next) {
	          case 0:
	            url = env$1.consentServer + "/consent/v1/consents?subject=" + consentSubject + "&definition=track_browsing_history";
	            _context.next = 3;
	            return axios$1.get(url, { auth: { username: env$1.consentAccount, password: env$1.consentPassword } });
	          ...
	          case 3:
	            ...
	            return _context.abrupt("return", response.data._embedded.consents[0].status);
	  ...
	  return function getConsentStatus() {
	    return _ref.apply(this, arguments);
	  };
	}();
	...
	var saveConsent = function () {
	  var _ref2 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(prompt) {
	    var url, record;
	    return regeneratorRuntime.wrap(function _callee2$(_context2) {
	      while (1) {
	        switch (_context2.prev = _context2.next) {
	          case 0:
	            url = env$1.consentServer + "/consent/v1/consents";
	            record = {
	              definition: {
	                id: "track_browsing_history",
	                locale: "en-US",
	            ...
	            _context2.next = 4;
	            return axios$1.post(url, record, { auth: { username: env$1.consentAccount, password: env$1.consentPassword } });
	  ...
	  return function saveConsent(_x) {
	    return _ref2.apply(this, arguments);
	  };
	}();
	...
	var maybeTrackBrowsingHistory = function () {
	      ...
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          ...
	          case 8:
	            ...
	            prompt = new ConsentPrompt("track_browsing_history");
	            _context3.next = 11;
	  ...
	  return function maybeTrackBrowsingHistory() {
	    return _ref3.apply(this, arguments);
	  };
	}();

	var consentSubject = getCurrentUser();
